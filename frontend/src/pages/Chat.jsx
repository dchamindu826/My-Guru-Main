      ...
      setSessions(prev => {
          ...
          if (subjectHistory.length === 0) {
              ...
              const welcomeMsg = {
                  id: 'init-welcome',
                  role: 'ai',
                  // 🔥 UPDATED: Clean, Friendly & Attractive Message (No Stars)
                  content: `ආයුබෝවන් ${firstName}! 👋\n\nමම My Guru. ඔයාගේ පුද්ගලික AI ගුරුවරයා. 🎓\n\nඅද අපි ${subject} පාඩම පටන් ගමු. 📚\n\nඔයාට තියෙන ඕනෑම ප්‍රශ්නයක් මගෙන් අහන්න. මම ලෑස්තියි ඔයාට සරලව කියලා දෙන්න.\n\nසිංහල, English හෝ Singlish වලින් අහන්න වගේම ගණන් හදන්න ඕන නම් ෆොටෝ එකක් එවන්නත් පුළුවන්. 📸\n\nඅපි වැඩේ පටන් ගමු! 🚀`,
                  timestamp: new Date()
              };
